...
(ns readlature.servlet
  (:gen-class
    :extends javax.servlet.http.HttpServlet)
  (:use clojure.set
        compojure)
  (:require
    [readlature.articles :as articles]
  ...
  (html
    [:div.footer
      [:div.bookmarklet
        ...
        (link-to bookmarklet "Read Lature")]
      [:div.signout
        "logged as "
...
(defn unread-help []
  (html
    [:div.help
      ...
      [:p "Drag the bookmarklet " (link-to bookmarklet "Read Lature") "
...
;; (defservice readlature-app)
(defservice (users/wrap-requiring-login readlature-app))